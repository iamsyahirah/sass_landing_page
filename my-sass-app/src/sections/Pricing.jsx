                ...
                <div className="container">
                    <div className="max-w-960 pricing-head_before relative mx-auto border-l border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                        ...
                        <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[-3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
                            ...
                            <button className={clsx('pricing-head_btn', !monthly && "text-p4")}
                                onClick={() => setMonthly(false)}>Annual
                            </button>
                    ...
                    <div className="scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
                        {plans.map((plan, index) => (
                            <div
                                ...
                                >
                                    <div className={clsx('small-2 rounded-20 relative z-2 mx-auto mb-6 border-2 px-4 py-1.5 uppercase', index === 1 ? "border-p3 text-p3" : "border-p1",)}
                                    >
                                        {plan.title}
                                    </div>
